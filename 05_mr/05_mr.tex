...
\begin{frame}[c]{}
     \begin{figure}
    	 \centering
          \includegraphics[height=5cm,angle=270]{images/rafael}
    \end{figure}
...
%\begin{frame}[c]
   % \begin{figure}
      %  \centering
       % \subcaptionbox{\longtime{}-weighted MRI}{\includegraphics[height=5cm]{images/5009-dkfz-t1}}
        %\subcaptionbox{\transtime{}-weighted MRI}{\includegraphics[height=5cm]{images/5009-dkfz-t2}}
    %\end{figure}
%\end{frame}
...
\begin{frame}[c]{CT vs.~MRI}
    ...
    \begin{columns}[c,onlytextwidth]
        ...
        \begin{block}{CT}
            \begin{itemize}
                \small
               % \item Just doing a test modification
...
\begin{frame}[c]{CT vs.~MRI}
    \begin{figure}
        \centering
        \subcaptionbox{CT*}{\includegraphics[height=4.5cm]{images/vhm-brainct}}
        \subcaptionbox{\longtime{}-weighted MRI}{\includegraphics[height=4.5cm]{images/5009-dkfz-t1}}
        \subcaptionbox{\transtime{}-weighted MRI}{\includegraphics[height=4.5cm]{images/5009-dkfz-t2}}
    \end{figure}
...
\only<1>{\input{tikz/compass_1.tikz}}%
\only<2>{\input{tikz/compass_2.tikz}}%
\only<3>{\input{tikz/compass_3.tikz}}%
\only<4>{\input{tikz/compass_4.tikz}}%
\endgroup
\end{center}
    ...
    \begin{columns}
        ...
        \begin{center}
            \begin{tikzpicture}[scale=1.4]
                \only<1>{\node at (0,0.25) [anchor=south west] {\includegraphics[scale=0.14]{images/random_spins}};}
                \only<2>{
...
\begin{frame}{Longitudinal Magnetization Recovery}
    ...
    \begin{center}
        %\input{tikz/longitudinal_magnetization_recovery.tikz}
...
\begin{frame}{Transversal Magnetization Decay (in theory)}
    ...
    \begin{center}
        %\input{tikz/transverse_magnetization_recovery.tikz}
...
\begin{frame}{\longtime{} Weighting}
    ...
    \begin{columns}[t,onlytextwidth]
        \column{.7\linewidth}
        %\input{tikz/longitudinal_magnetization_recovery_2tissues.tikz}
...
\begin{frame}{\transtime{} Weighting}
    ...
    \begin{columns}[t,onlytextwidth]
        \column{.7\linewidth}
        %\input{tikz/transverse_magnetization_recovery_2tissues.tikz}
