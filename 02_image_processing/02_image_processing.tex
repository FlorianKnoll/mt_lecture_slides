...
\begin{tikzpicture}
\begin{axis}[xmin=0, xmax=1, ymin=0, ymax=1, width=0.8\textwidth,
xlabel=$x$, ylabel=$g(x)$]
...
%\frame[plain,c]{\titlepage}
\section{Image Processing -- Non-linear Methods}%
...
% This example was calculated with Otsu's method 
\begin{frame}{Segmentation Example 1}
...
% This example was calculated with manual threshholds
\begin{frame}{Segmentation Example 2 -- Manual thresholds (CT)}
    \vspace{-0.5em}
    \begin{columns}[onlytextwidth,T]
...
% This example was calculated with manual threshholds
\begin{frame}{Example for morphological operations}
    %\vspace{1.0em}
    \begin{columns}[onlytextwidth,T]
