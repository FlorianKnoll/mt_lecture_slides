...
\begin{frame}{Sources of Noise}
    \begin{itemize}
        ...
        \item Difference: When scan is repeated with identical settings,
              \begin{itemize}
                  \item artifacts (e.g., vignetting effect) will remain unchanged
...
\begin{frame}{Poisson distribution}
    ...
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.4\textwidth}
            \begin{itemize}
                \item Poisson distribution is discrete distribution with mass function:
                      \begin{equation*}
...
\begin{frame}{Binomial distribution}
    \begin{itemize}
        ...
        \item For $n \rightarrow \infty$ and $p \rightarrow 0$: Poisson distribution
    \end{itemize}\vspace{0cm}
    \begin{center}
        \includegraphics[width=0.275\columnwidth]{images/Binomi}%
    \end{center}
\end{frame}
    ...
    \begin{itemize}
        ...
        \item Probability $p_a$ for a photon passing unaffected is given by Beer's law
              \begin{equation*}
                  p_a = e^{-\int \mu(s) ds}
              \end{equation*}
        \item Probability that $n_s$ photons pass unaffected \textbf{and} that $N_x$ photons have been produced is called the \textbf{Joint Probability} $P(n_s,N_x)$
        \item If you have binomial process following a Poisson process, it is still a Poisson process
...
\begin{frame}{SNR and Noise}
    \begin{itemize}
        ...
        \item Different noise level in every pixel
    \end{itemize}
\end{frame}
...
\begin{frame}{Fluroscopy}
    %
 Sequence of radiography images with certain framerate
    \begin{columns}[t, onlytextwidth]
        \begin{column}{0.4\textwidth}
            \begin{figure}[htpb]
                \centering
            \includegraphics[height=0.5\textheight]{images/Fluoroscopy_pacemaker_leads_right_atrium_ventricle}%
        ...
        \begin{figure}
            \centering
            \includegraphics[height=0.5\textheight]{Siemens_Images/SH_AX_36710_13}%
