...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Blackboard Exercise: \tabto{3cm} Erik G\"osche, Nils Dienesch
			\item Final Project: \tabto{3cm} Mischa Dombrowski
			\item Homework Tasks: \tabto{3cm} Johanna M\"uller, Haiting Huang
			\item Student Tutors: \tabto{3cm} Kathrin M\"arz, Jacob Plentinger, Leonie Schmutzler, Kathy Vo
		\end{itemize}
		\item Contact: \texttt{\url{https://www.studon.fau.de/studon/go/crs/6732094}}
	\end{itemize}
\end{frame}
...
\begin{frame}[c]{Lectures}
	\begin{itemize}
		...
		\item Tuesday 10:15 - 11:45 and Wednesday 14:15 - 15:45 here in HS18 and on \href{https://teams.microsoft.com/l/team/19\%3adRCxup9jUsjM31xr9T4jdAFDB-ImEk_lU5Fy05ijYx81\%40thread.tacv2/conversations?groupId=6b2df36b-cec0-46b3-83d2-b4e6d1c6ac30\&tenantId=b2efcef3-8496-40b8-9de8-f135982f3461}{MS Teams}
		\item MS Teams channel password/link is in the StudOn course
		\item 2025 Lecture Recordings in English on FAU.tv:\\
		\texttt{\url{https://www.fau.tv/series/medical-engineering-ii-s25?sortField=episode}}\\
...
\begin{table}[]
\begin{tabular}{rll}
\multicolumn{1}{l}{Date} & \multicolumn{1}{l}{Topic}   			   	& \multicolumn{1}{c}{Lecturer} \\
14.04.26                 & Introduction, System theory 1				&                Knoll      \\
15.04.26                 & System theory 2           		    			&                Knoll      \\
21.04.26                 & Image processing 1   		         		&                 Kainz     \\
22.04.26                 & Image processing 2				 		&                 Kainz     \\
28.04.26                 & Endoscopy, Microscopy 1			       		&                 Kainz     \\
29.04.26                 & Microscopy 2		     			  		&                 Kainz     \\
05.05.26                 & Ultrasound 1	                					&                 Kainz     \\
06.05.26                 & Ultrasound 2: Applications and demo		&                 Kainz     \\
12.05.26                 & OCT									&                 Kainz     \\
13.05.26                 & X-ray 1: Ray generation					&                 Knoll     \\
19.05.26                 & X-ray 2: Matter interaction, imaging 			&                 Knoll     \\
20.05.26                 & CT 1: Basic concepts, reconstruction		&                 Knoll     \\
\st{26.05.26}           & No lecture (Bergdienstag)					&                     \\
27.05.26                 & CT 2: Resolution, noise, artifacts, spectral CT	&                 Knoll     \\
02.06.26                 & MRI 1: Nuclear magnetic resonance 		&  		Knoll	\\
03.06.26                 & MRI 2: Imaging							&		Knoll	\\
09.06.26                 & Nuclear medicine						&	Knoll
\end{tabular}
\end{table}
}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Homework}
		\begin{itemize}
			\item Five exercises during semester
			\item Each exercise consists of theory (10 points) and programming (10 points) tasks
			\item Bonus points: >50\% 0.3 grade improvement, >90\% 0.7 grade improvement
		...
		\begin{center}
			\begin{tabular}{c | c | c | c}
				\# & Handout (Mon) 	& Blackboard exercise (Wed 12:15)	& Submission (Sun 23:00) \\ \hline
				1  & 20.04.26    	& 22.04.26               				& 26.04.26       \\
				2  & 27.04.26    	& 29.04.26                				& 03.05.26       \\
				3  & 04.05.26    	& 06.05.26                				& 10.05.26       \\
				4  & 25.05.26    	& 20.05.26 (online)               	    & 31.05.26       \\
				5  & 01.06.26    	& 27.05.26                				& 14.06.26       \\
				6  & --    			& 03.06.26                				& --       \\
			\end{tabular}
		\end{center}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{Blackboard Exercises}
		\begin{itemize}
			...
			\item HS19 in person only
		\end{itemize}
	\end{block}
	\begin{block}{Computer Exercises}
		\begin{itemize}
			\item Support for programming tasks by student tutors
			\item Capacity: max 25 Students
			\item Schedule (starting on 20.04.2026)
			\begin{itemize}
				\item Mo 14:15 - 15:45 CIP2
				\item Tu 08:15 - 09:45 CIP1
				\item We 08:15 - 09:45 CIP1
				\item Fr 10:15 - 11:45 CIP2
			\end{itemize}
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			\item Writing of a short scientific report
		...
		\begin{itemize}
			...
			\item Potentially additional blackboard excercise (watch StudOn for updates)
		\end{itemize}
	\end{itemize}
\end{frame}
...
% \frame{Magnetic Resonance Imaging}
...
% SPECT: \href{https://youtu.be/mTrOgOWb7nY}{https://youtu.be/mTrOgOWb7nY}
	...
	\begin{columns}[c, onlytextwidth]
		...
		\end{column}\begin{column}{0.5\textwidth}
			\begin{figure}
				\centering{}
				\includegraphics[width=1.0\linewidth,trim={0 0 2.5cm 0}]{images/boneproj.png} % [trim={left bottom right top}]
